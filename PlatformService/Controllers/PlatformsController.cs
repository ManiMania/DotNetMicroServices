...
public class PlatformsController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<ActionResult<PlatformReadDto>> CreatePlatform(PlatformCreateDto plaftformCreateDto)
    {
        var platformModel = _mapper.Map<Platform>(plaftformCreateDto);
        ...
        try
        {
            ...
            platformPublisedDto.Event = "Platform_Publisher";
